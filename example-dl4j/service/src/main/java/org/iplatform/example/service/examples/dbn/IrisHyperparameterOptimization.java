...
import org.iplatform.example.service.examples.arbiter.BasicHyperparameterOptimizationExample;
...
@Component
public class IrisHyperparameterOptimization implements IExample {
    @Override
    public void run() {
        try {
            int numInputs = 4;
            ...
            //定义模型存储目录
            String baseSaveDirectory = "arbiterIris/";
